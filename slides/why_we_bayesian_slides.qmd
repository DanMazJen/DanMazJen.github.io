...
Their instinct is: > "Let the data speak for itself"
...
3. Not using quardratic approximation of likelihood (for SD etc.)
...
:::::
::::: {.column}
![A prior can save you from foolish inference](assets/kxcd-bayes-freq.png)
:::::
:::
